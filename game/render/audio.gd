...
func _gen_all() -> void:
	...
	streams["spring"] = _cue([[200.0, 720.0, 0.16, "square", 0.35, 0.0]])
	...
	streams["die"] = _cue([[240.0, 50.0, 0.30, "saw", 0.45, 0.0], [0.0, 0.0, 0.22, "noise", 0.30, 0.0]])
	streams["dunk"] = _cue([[660.0, 660.0, 0.07, "square", 0.35, 0.0], [990.0, 990.0, 0.10, "square", 0.35, 0.08]])
	...
	streams["lose"] = _cue([[392.0, 369.0, 0.20, "saw", 0.30, 0.0], [330.0, 310.0, 0.20, "saw", 0.30, 0.16], [262.0, 246.0, 0.20, "saw", 0.30, 0.32], [196.0, 184.0, 0.26, "saw", 0.30, 0.48]])
